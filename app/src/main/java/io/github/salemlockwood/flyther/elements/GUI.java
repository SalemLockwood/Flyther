...
public class GUI {
    ...
    private void drawSettingsScreen(Canvas canvas) {
        SharedPreferences sp = context.getSharedPreferences("io.github.salemlockwood.flyther",Context.MODE_PRIVATE);
        ...
        canvas.drawText(showUpdateRateString,150,400, Colors.getGuiColor(context));
    ...
    public void drawMenuScreen(Canvas canvas){
        ...
        canvas.drawText(settingsString,150,550, Colors.getGuiDisabledColor(context));
